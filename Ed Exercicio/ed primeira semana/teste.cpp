...
void portfolio::redimensionarCapacidade() {
	int tam= capacidadeMaxima+4;
	produto *lojinha=new produto[tam];
	copy(listaDeProdutos, listaDeProdutos+quantidadeDeProdutos,lojinha);
	capacidadeMaxima=tam;
	delete[] listaDeProdutos;
	listaDeProdutos=lojinha;
}
...
portfolio::portfolio(const portfolio& umPort){
	this->quantidadeDeProdutos=umPort.quantidadeDeProdutos;
	this->capacidadeMaxima=umPort.capacidadeMaxima;
	this->listaDeProdutos=new produto[capacidadeMaxima];
	copy(umPort.listaDeProdutos,umPort.listaDeProdutos+umPort.capacidadeMaxima,this->listaDeProdutos);
}
