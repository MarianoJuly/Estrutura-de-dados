...
class avl{
	...
	private:
		...
		noh* buscaAux(noh* umNoh, tipoChave chave);
		...
		void levantamentoAux(noh* umNoh, string especie, string raca, int& quant);
	...
	void avl::levantamentoAux(noh* umNoh, string especie, string raca, int& quant){
		
		if(umNoh != NULL){
			
			levantamentoAux(umNoh->esq, especie, raca, quant);
			if((especie == umNoh->elemento.especie) and (raca == umNoh->elemento.raca))
				quant++;
			levantamentoAux(umNoh->dir, especie, raca, quant);
		}
	}
	...
	int avl::levantamento(string especie, string raca){
		...
		levantamentoAux(raiz, especie, raca, quantidade);
...
void avl::imprimirDir(const std::string& prefixo, const noh* meuNoh){
	...
	if(meuNoh != nullptr){
		...
		std::cout << prefixo << "└d─" << "(" << meuNoh->elemento.chave << "," << meuNoh->elemento.nomeAnimal << ")" << std::endl;
...
void avl::imprimirEsq(const std::string& prefixo, const noh* meuNoh, bool temIrmao){
	...
	if(meuNoh != nullptr){
		...
		std::cout << "(" << meuNoh->elemento.chave << "," << meuNoh->elemento.nomeAnimal << ")" << std::endl;
